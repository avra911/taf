 ...
 */
class Lofty_Selenium_TestCase extends PHPUnit_Extensions_SeleniumTestCase
{
    ################################################################################
     ...
     * @var string
     */
    protected $_firstPageAfterAdminLogin = 'bidashboard';
    ...
    protected function _loadHelper($testScope)
    {
        ...
        if (self::$_testHelpers[$helperClassName] instanceof Lofty_Selenium_TestCase) {
     ...
     *
     * @return Lofty_Selenium_TestCase
     */
    public function helper($className)
    {
        ...
        if (self::$_testHelpers[$className] instanceof Lofty_Selenium_TestCase) {
            foreach (get_object_vars($this) as $name => $value) {
     ...
     * @static
     *
     * @param bool|Lofty_Selenium_TestCase $condition Condition to assert
     ...
     *
     * @param string $page Page identifier (by default = 'bidashboard')
     * @param bool $validatePage
     *
     * @return Lofty_Selenium_TestCase
     */
    public function admin($page = 'bidashboard', $validatePage = true)
    {
    ...
    protected static function _getMcaFromCurrentUrl($areasConfig, $currentUrl)
    {
        ...
        $mca = preg_replace('/(customer\/account\/login\/referer)\/.*/', '$1',$mca);
    ...
    /**
     * Click a link with the specified name
     *
     * @param $link
     * @param bool $willChangePage Triggers page reloading. If clicking the control doesn't result<br>
     * in page reloading, should be false (by default = true).
     *
     * @internal param string $button Name of a control from UIMap
     * @return Lofty_Selenium_TestCase
     */


    public function clickLink($link, $willChangePage = true)
    {
        return $this->clickControl('link', $link, $willChangePage);
    }
    /**
     * Clicks a control with the specified name and type
    ...
    public function clickLinkAndConfirm($linkName, $message, $willChangePage = true)
    {
        return $this->clickControlAndConfirm('link', $linkName, $message, $willChangePage);
    }
    /**
